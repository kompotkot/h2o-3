...
The ice_root folder is where H2O will store temporary files, and by default it would be in the '/tmp' folder (as '/tmp/h2o-<USERNAME>'). Check that the user launching H2O has write access to the folder. 
